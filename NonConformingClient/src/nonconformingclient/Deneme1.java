 ...
 * @author mkaplan
 */
public class Deneme1 extends javax.swing.JFrame {
     ...
     */
    public Deneme1(RmiInterface in) {
        initComponents();
...
//        uygnszlk_nedeni = jTextArea2.getText();
	...
	RMICommon common = new RMICommon();
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Deneme1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
